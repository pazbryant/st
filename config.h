 ...
 */
static char *font = "Maple Mono NF:pixelsize=12:style:Regular:antialias=true:autohint=true";
static char *font2[] = { "JetBrainsMono NFM:pixelsize=12:antialias=true:autohint=true" };
static char *font3[] = { "monospace:pixelsize=12:antialias=true:autohint=true" };
